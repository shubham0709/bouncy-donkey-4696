...
const HowItWorks = () => {
  return (
    <Box fontFamily={'Avenirnextltpro, sans-serif'}>
      <Box w="80%" margin={"auto"}>
        ...
        <Button colorScheme="blue" width={'262px'} height='62px' fontFamily={'"Avenir Next",sans-serif'}  mt="25px"
        mb="80px">Get Started-Its Free</Button>
      </Box>

      <AspectRatio maxW="916px" ratio={1} margin='auto' mt='50px'  height="573px" mb={'100px'}>
        <iframe
          width="916px"
      ...
      <Box>
        ...
        <Text w="60%" margin={"auto"} fontFamily={'"Avenir Next", sans-serif'} mb='25px'>
          Breaking down your work into projects and tasks is done with a few
          keystrokes. Prioritize tasks, add details and assign them to your team
          to complete. Set up an estimated budget on a project or task level.
        </Text>
      </Box>

      <Box width={'940px'}  height={'628 px'} margin='auto' marginBottom={'50px'}>
        <Image 
      ...
      <Text w="60%" margin={"auto"} fontFamily={'"Avenir Next", sans-serif'}  marginBottom='25px'>
  ...
  <Text w="60%" margin={"auto"} fontFamily={'"Avenir Next", sans-serif'}  marginBottom='25px' textAlign={'justify'}>
